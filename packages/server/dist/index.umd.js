(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('dataloader'), require('lodash'), require('@hello10/logger'), require('apollo-server-cloud-functions'), require('graphql-tools'), require('debug')) :
  typeof define === 'function' && define.amd ? define(['exports', 'dataloader', 'lodash', '@hello10/logger', 'apollo-server-cloud-functions', 'graphql-tools', 'debug'], factory) :
  (global = global || self, factory(global.jumpServer = {}, global.dataloader, global.lodash, global.Logger, global.apolloServerCloudFunctions, global.graphqlTools, global.debug));
}(this, (function (exports, DataLoader, lodash, Logger, apolloServerCloudFunctions, graphqlTools, makeDebug) {
